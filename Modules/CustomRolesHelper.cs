    ...
    public static CustomRoles GetVNRole(this CustomRoles role) // 对应原版职业
    {
        return role.IsVanilla()
            ...
            : role switch
            {
                ...
                CustomRoles.Rudepeople => !Options.UsePets.GetBool() ? CustomRoles.Engineer : CustomRoles.Crewmate,
                ...
                CustomRoles.TimeStops => !Options.UsePets.GetBool() ? CustomRoles.Engineer : CustomRoles.Crewmate,
                ...
                CustomRoles.GlennQuagmire =>  !Options.UsePets.GetBool() ? CustomRoles.Engineer : CustomRoles.Crewmate,

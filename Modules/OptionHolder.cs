...
public static class Options
{
    ...
    public static OptionItem QXZShields;
    ...
    public static OptionItem BWZVentCD;
    public static OptionItem BWZSkillTimes;
    public static OptionItem BWZTurns;
    ...
    public static readonly string[] CamouflageMode =
{
    ...
    public static void Load()
    {
        ...
        Options.SetupRoleOptions(345679, TabGroup.ImpostorRoles, CustomRoles.QXZ);
        QXZShields = IntegerOptionItem.Create(345689, "QXZShields", new(1, 3, 1), 1, TabGroup.ImpostorRoles, false).SetParent(Options.CustomRoleSpawnChances[CustomRoles.QXZ]);
       ...
       .SetValueFormat(OptionFormat.Percent);
        ...
        HemophobiaKillColldown = FloatOptionItem.Create(179864, "KillCooldown", new(0f, 100f, 2.5f), 10f, TabGroup.ImpostorRoles, false).SetParent(CustomRoleSpawnChances[CustomRoles.Hemophobia])
            .SetValueFormat(OptionFormat.Seconds);
